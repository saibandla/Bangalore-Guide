...
- (void)viewDidLoad {
   ...
   AppDelegate *appDelegate=(AppDelegate *)[[UIApplication sharedApplication] delegate];
    NSEntityDescription *entityDesc=[NSEntityDescription entityForName:@"Favourites" inManagedObjectContext:appDelegate.managedObjectContext] ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BOOL isInfavourites=NO;
    for(NSDictionary *dic in favData)
    {
       if( [dic.allValues containsObject:[location objectForKey:@"lat"]]&&[dic.allValues containsObject:[location objectForKey:@"lat"]])
       {
           isInfavourites=YES;
       }
    }
    ...
    MapLocator *locat=[[MapLocator alloc]initWithNibName:@"MapLocator" bundle:nil LocationName:name LocationAddress:address Coordinates:coordinates image:cell.imgV.image isThereInFav:(BOOL) isInfavourites];
